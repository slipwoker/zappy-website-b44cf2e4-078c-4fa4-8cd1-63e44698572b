  ...
  if (contactForm) {
    ...
    function showFieldError(field, message) {
      ...
      if (!errorEl) {
        ...
        errorEl.id = field.id ? field.id + '-error' : '';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b44cf2e4-078c-4fa4-8cd1-63e44698572b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b44cf2e4-078c-4fa4-8cd1-63e44698572b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b44cf2e4-078c-4fa4-8cd1-63e44698572b';
